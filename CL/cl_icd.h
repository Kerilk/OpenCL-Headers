...
// Platform APIs
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetPlatformInfo) (cl_platform_id platform,
...
// Device APIs
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetDeviceIDs) (cl_platform_id platform,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetDeviceInfo) (cl_device_id device,
							 cl_device_info
							 param_name,
							 size_t
							 param_value_size,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clCreateSubDevices) (cl_device_id in_device,
					      const
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainDevice) (cl_device_id device)
...
// Context APIs
  typedef cl_context (CL_API_CALL *
		      cl_api_clCreateContext) (const cl_context_properties *
					       properties,
					       cl_uint num_devices,
					       const cl_device_id * devices,
					       void (CL_CALLBACK *
						     pfn_notify) (const char
								  *,
								  const void
								  *, size_t,
								  void *),
  ...
  typedef cl_context (CL_API_CALL *
		      cl_api_clCreateContextFromType) (const
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainContext) (cl_context context)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clReleaseContext) (cl_context context)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clGetContextInfo) (cl_context context,
							  cl_context_info
							  param_name,
							  size_t
							  param_value_size,
...
// Command Queue APIs
  typedef cl_command_queue (CL_API_CALL *
			    cl_api_clCreateCommandQueue) (cl_context context,
							  cl_device_id device,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainCommandQueue) (cl_command_queue
						command_queue)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clReleaseCommandQueue) (cl_command_queue
						 command_queue)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clGetCommandQueueInfo) (cl_command_queue
						 command_queue,
...
// Memory Object APIs
  ...
  typedef cl_mem (CL_API_CALL * cl_api_clCreateImage) (cl_context context,
						       cl_mem_flags flags,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateBufferWithProperties) (cl_context context,
							const
							cl_mem_properties *
							properties,
							cl_mem_flags flags,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateImageWithProperties) (cl_context context,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetContextDestructorCallback) (cl_context context,
							  void (CL_CALLBACK *
								pfn_notify)
							  (cl_context context,
							   void *user_data),
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainMemObject) (cl_mem memobj)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clReleaseMemObject) (cl_mem memobj)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clGetSupportedImageFormats) (cl_context context,
						      cl_mem_flags flags,
						      cl_mem_object_type
						      image_type,
						      cl_uint num_entries,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetMemObjectInfo) (cl_mem memobj,
							    cl_mem_info
							    param_name,
							    size_t
							    param_value_size,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreatePipe) (cl_context /* context */ ,
					cl_mem_flags /* flags */ ,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetPipeInfo) (cl_mem /* pipe */ ,
						       cl_pipe_info
						       /* param_name */ ,
						       size_t
						       /* param_value_size */
...
// Sampler APIs
  typedef cl_sampler (CL_API_CALL *
		      cl_api_clCreateSampler) (cl_context context,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainSampler) (cl_sampler sampler)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clReleaseSampler) (cl_sampler sampler)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clGetSamplerInfo) (cl_sampler sampler,
							  cl_sampler_info
							  param_name,
							  size_t
							  param_value_size,
  ...
  typedef cl_sampler (CL_API_CALL *
		      cl_api_clCreateSamplerWithProperties) (cl_context
							     /* context */ ,
							     const
...
// Program Object APIs
  typedef cl_program (CL_API_CALL *
		      cl_api_clCreateProgramWithSource) (cl_context context,
							 cl_uint count,
							 const char **strings,
							 const size_t
							 *lengths,
  ...
  typedef cl_program (CL_API_CALL *
		      cl_api_clCreateProgramWithBinary) (cl_context context,
							 cl_uint num_devices,
							 const cl_device_id *
							 device_list,
							 const size_t
  ...
  typedef cl_program (CL_API_CALL *
		      cl_api_clCreateProgramWithBuiltInKernels) (cl_context
								 context,
								 cl_uint
								 num_devices,
								 const
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainProgram) (cl_program program)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clReleaseProgram) (cl_program program)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL * cl_api_clBuildProgram) (cl_program program,
							cl_uint num_devices,
							const cl_device_id *
							device_list,
							const char *options,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clCompileProgram) (cl_program program,
							  cl_uint num_devices,
							  const cl_device_id *
							  device_list,
							  const char *options,
  ...
  typedef cl_program (CL_API_CALL * cl_api_clLinkProgram) (cl_context context,
							   cl_uint
							   num_devices,
							   const cl_device_id
							   * device_list,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetProgramSpecializationConstant) (cl_program
							      program,
							      cl_uint spec_id,
							      size_t
							      spec_size,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetProgramReleaseCallback) (cl_program program,
						       void (CL_CALLBACK *
							     pfn_notify)
						       (cl_program program,
							void *user_data),
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clUnloadPlatformCompiler) (cl_platform_id platform)
    CL_API_SUFFIX__VERSION_1_2;
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetProgramInfo) (cl_program program,
							  cl_program_info
							  param_name,
							  size_t
							  param_value_size,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetProgramBuildInfo) (cl_program program,
						 cl_device_id device,
...
// Kernel Object APIs
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clCreateKernelsInProgram) (cl_program program,
						    cl_uint num_kernels,
						    cl_kernel * kernels,
						    cl_uint *
						    num_kernels_ret)
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainKernel) (cl_kernel kernel)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clReleaseKernel) (cl_kernel kernel)
    CL_API_SUFFIX__VERSION_1_0;
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetKernelInfo) (cl_kernel kernel,
							 cl_kernel_info
							 param_name,
							 size_t
							 param_value_size,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetKernelArgInfo) (cl_kernel kernel,
							    cl_uint arg_indx,
							    cl_kernel_arg_info
							    param_name,
							    size_t
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetKernelWorkGroupInfo) (cl_kernel kernel,
						    cl_device_id device,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetKernelArgSVMPointer) (cl_kernel /* kernel */ ,
						    cl_uint /* arg_index */ ,
						    const void *
						    /* arg_value */ )
    CL_API_SUFFIX__VERSION_2_0;
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetKernelExecInfo) (cl_kernel /* kernel */ ,
					       cl_kernel_exec_info
					       /* param_name */ ,
					       size_t /* param_value_size */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetKernelSubGroupInfoKHR) (cl_kernel
						      /* in_kernel */ ,
						      cl_device_id
						      /*in_device */ ,
...
// Event Object APIs
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainEvent) (cl_event event)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clReleaseEvent) (cl_event event)
    CL_API_SUFFIX__VERSION_1_0;

// Profiling APIs
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetEventProfilingInfo) (cl_event event,
						   cl_profiling_info
						   param_name,
						   size_t param_value_size,
						   void *param_value,
...
// Flush and Finish APIs
  typedef cl_int (CL_API_CALL *
		  cl_api_clFlush) (cl_command_queue command_queue)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clFinish) (cl_command_queue command_queue)
    CL_API_SUFFIX__VERSION_1_0;

// Enqueued Commands APIs
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReadBuffer) (cl_command_queue command_queue,
					       cl_mem buffer,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReadBufferRect) (cl_command_queue
						   command_queue,
						   cl_mem buffer,
						   cl_bool blocking_read,
						   const size_t
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueWriteBuffer) (cl_command_queue
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueWriteBufferRect) (cl_command_queue
						    command_queue,
						    cl_mem buffer,
						    cl_bool blocking_read,
						    const size_t
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueFillBuffer) (cl_command_queue command_queue,
					       cl_mem buffer,
					       const void *pattern,
					       size_t pattern_size,
					       size_t offset, size_t cb,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueCopyBuffer) (cl_command_queue command_queue,
					       cl_mem src_buffer,
					       cl_mem dst_buffer,
					       size_t src_offset,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueCopyBufferRect) (cl_command_queue
						   command_queue,
						   cl_mem src_buffer,
						   cl_mem dst_buffer,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReadImage) (cl_command_queue command_queue,
					      cl_mem image,
					      cl_bool blocking_read,
					      const size_t *origin,
					      const size_t *region,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueWriteImage) (cl_command_queue command_queue,
					       cl_mem image,
					       cl_bool blocking_write,
					       const size_t *origin,
					       const size_t *region,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueFillImage) (cl_command_queue command_queue,
					      cl_mem image,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueCopyImage) (cl_command_queue command_queue,
					      cl_mem src_image,
					      cl_mem dst_image,
					      const size_t *src_origin,
					      const size_t *dst_origin,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueCopyImageToBuffer) (cl_command_queue
						      command_queue,
						      cl_mem src_image,
						      cl_mem dst_buffer,
						      const size_t
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueCopyBufferToImage) (cl_command_queue
						      command_queue,
						      cl_mem src_buffer,
						      cl_mem dst_image,
						      size_t src_offset,
  ...
  typedef void *(CL_API_CALL *
		 cl_api_clEnqueueMapBuffer) (cl_command_queue command_queue,
					     cl_mem buffer,
  ...
  typedef void *(CL_API_CALL *
		 cl_api_clEnqueueMapImage) (cl_command_queue command_queue,
					    cl_mem image,
					    cl_bool blocking_map,
					    cl_map_flags map_flags,
					    const size_t *origin,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueUnmapMemObject) (cl_command_queue
						   command_queue,
						   cl_mem memobj,
						   void *mapped_ptr,
						   cl_uint
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueMigrateMemObjects) (cl_command_queue
						      command_queue,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueNDRangeKernel) (cl_command_queue
						  command_queue,
						  cl_kernel kernel,
						  cl_uint work_dim,
						  const size_t
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueTask) (cl_command_queue command_queue,
					 cl_kernel kernel,
					 cl_uint num_events_in_wait_list,
					 const cl_event * event_wait_list,
					 cl_event *
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueNativeKernel) (cl_command_queue
						 command_queue,
						 void (CL_CALLBACK *
						       user_func) (void *),
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueMarkerWithWaitList) (cl_command_queue
						       command_queue,
						       cl_uint
						       num_events_in_wait_list,
						       const cl_event *
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueBarrierWithWaitList) (cl_command_queue
							command_queue,
							cl_uint
							num_events_in_wait_list,
							const cl_event *
...
// Shared Virtual Memory APIs
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMFree) (cl_command_queue
					    /* command_queue */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMMemcpy) (cl_command_queue
					      /* command_queue */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMMemFill) (cl_command_queue
					       /* command_queue */ ,
					       void * /* svm_ptr */ ,
					       const void * /* pattern */ ,
					       size_t /* pattern_size */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMMap) (cl_command_queue
					   /* command_queue */ ,
					   cl_bool /* blocking_map */ ,
					   cl_map_flags /* map_flags */ ,
					   void * /* svm_ptr */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMUnmap) (cl_command_queue
					     /* command_queue */ ,
					     void * /* svm_ptr */ ,
					     cl_uint
					     /* num_events_in_wait_list */ ,
...
// Deprecated APIs
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetCommandQueueProperty) (cl_command_queue
						     command_queue,
						     cl_command_queue_properties
						     properties,
						     cl_bool enable,
  ...
  typedef cl_mem (CL_API_CALL * cl_api_clCreateImage2D) (cl_context context,
							 cl_mem_flags flags,
							 const cl_image_format
							 * image_format,
							 size_t image_width,
  ...
  typedef cl_mem (CL_API_CALL * cl_api_clCreateImage3D) (cl_context context,
							 cl_mem_flags flags,
							 const cl_image_format
							 * image_format,
							 size_t image_width,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clUnloadCompiler) (void)
    CL_API_SUFFIX__VERSION_1_1_DEPRECATED;

  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueMarker) (cl_command_queue command_queue,
					   cl_event *
					   event)
    CL_API_SUFFIX__VERSION_1_1_DEPRECATED;

  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueWaitForEvents) (cl_command_queue
						  command_queue,
						  cl_uint num_events,
						  const cl_event *
						  event_list)
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueBarrier) (cl_command_queue command_queue)
    CL_API_SUFFIX__VERSION_1_1_DEPRECATED;

  typedef void *(CL_API_CALL *
		 cl_api_clGetExtensionFunctionAddress) (const char
							*function_name)
    CL_API_SUFFIX__VERSION_1_1_DEPRECATED;

// GL and other APIs
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromGLBuffer) (cl_context context,
						cl_mem_flags flags,
						cl_GLuint bufobj,
						int *errcode_ret)
    CL_API_SUFFIX__VERSION_1_0;
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromGLTexture) (cl_context context,
						 cl_mem_flags flags,
						 cl_GLenum target,
						 cl_GLint miplevel,
						 cl_GLuint texture,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromGLTexture2D) (cl_context context,
						   cl_mem_flags flags,
						   cl_GLenum target,
						   cl_GLint miplevel,
						   cl_GLuint texture,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromGLTexture3D) (cl_context context,
						   cl_mem_flags flags,
						   cl_GLenum target,
						   cl_GLint miplevel,
						   cl_GLuint texture,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromGLRenderbuffer) (cl_context context,
						      cl_mem_flags flags,
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetGLObjectInfo) (cl_mem memobj,
							   cl_gl_object_type *
							   gl_object_type,
							   cl_GLuint *
							   gl_object_name)
  ...
  typedef cl_int (CL_API_CALL * cl_api_clGetGLTextureInfo) (cl_mem memobj,
							    cl_gl_texture_info
							    param_name,
							    size_t
							    param_value_size,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueAcquireGLObjects) (cl_command_queue
						     command_queue,
						     cl_uint num_objects,
						     const cl_mem *
						     mem_objects,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReleaseGLObjects) (cl_command_queue
						     command_queue,
						     cl_uint num_objects,
						     const cl_mem *
						     mem_objects,
...
/* cl_khr_gl_sharing */
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetGLContextInfoKHR) (const cl_context_properties *
						 properties,
						 cl_gl_context_info
						 param_name,
						 size_t param_value_size,
...
/* cl_khr_gl_event */
  typedef cl_event (CL_API_CALL *
		    cl_api_clCreateEventFromGLsyncKHR) (cl_context context,
							cl_GLsync sync,
							cl_int * errcode_ret);
...
/* cl_khr_d3d10_sharing */
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetDeviceIDsFromD3D10KHR) (cl_platform_id platform,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D10BufferKHR) (cl_context context,
						      cl_mem_flags flags,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D10Texture2DKHR) (cl_context context,
							 cl_mem_flags flags,
							 ID3D10Texture2D *
							 resource,
							 UINT subresource,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D10Texture3DKHR) (cl_context context,
							 cl_mem_flags flags,
							 ID3D10Texture3D *
							 resource,
							 UINT subresource,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueAcquireD3D10ObjectsKHR) (cl_command_queue
							   command_queue,
							   cl_uint
							   num_objects,
							   const cl_mem *
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReleaseD3D10ObjectsKHR) (cl_command_queue
							   command_queue,
							   cl_uint
							   num_objects,
							   const cl_mem *
...
/* cl_khr_d3d11_sharing */
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetDeviceIDsFromD3D11KHR) (cl_platform_id platform,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D11BufferKHR) (cl_context context,
						      cl_mem_flags flags,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D11Texture2DKHR) (cl_context context,
							 cl_mem_flags flags,
							 ID3D11Texture2D *
							 resource,
							 UINT subresource,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromD3D11Texture3DKHR) (cl_context context,
							 cl_mem_flags flags,
							 ID3D11Texture3D *
							 resource,
							 UINT subresource,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueAcquireD3D11ObjectsKHR) (cl_command_queue
							   command_queue,
							   cl_uint
							   num_objects,
							   const cl_mem *
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReleaseD3D11ObjectsKHR) (cl_command_queue
							   command_queue,
							   cl_uint
							   num_objects,
							   const cl_mem *
...
/* cl_khr_dx9_media_sharing */
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetDeviceIDsFromDX9MediaAdapterKHR) (cl_platform_id
								platform,
								cl_uint
								num_media_adapters,
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromDX9MediaSurfaceKHR) (cl_context context,
							  cl_mem_flags flags,
							  cl_dx9_media_adapter_type_khr
							  adapter_type,
							  void *surface_info,
...
/* cl_khr_dx9_media_sharing */
  ...
  extern CL_API_ENTRY cl_mem CL_API_CALL
    clCreateFromDX9MediaSurfaceKHR (cl_context context,
				    cl_mem_flags flags,
				    cl_dx9_media_adapter_type_khr
				    adapter_type, void *surface_info,
...
/* OpenCL 1.1 */
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetEventCallback) (cl_event /* event */ ,
					      cl_int
  ...
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateSubBuffer) (cl_mem /* buffer */ ,
					     cl_mem_flags /* flags */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetMemObjectDestructorCallback) (cl_mem
							    /* memobj */ ,
							    void (CL_CALLBACK
								  *
								  /*pfn_notify */
  ...
  typedef cl_event (CL_API_CALL *
		    cl_api_clCreateUserEvent) (cl_context /* context */ ,
					       cl_int * /* errcode_ret */
					       ) CL_API_SUFFIX__VERSION_1_1;

  typedef cl_int (CL_API_CALL *
		  cl_api_clSetUserEventStatus) (cl_event /* event */ ,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clCreateSubDevicesEXT) (cl_device_id in_device,
						 const
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clRetainDeviceEXT) (cl_device_id device)
    CL_API_SUFFIX__VERSION_1_0;

  typedef cl_int (CL_API_CALL *
		  cl_api_clReleaseDeviceEXT) (cl_device_id device)
    CL_API_SUFFIX__VERSION_1_0;

/* cl_khr_egl_image */
  typedef cl_mem (CL_API_CALL *
		  cl_api_clCreateFromEGLImageKHR) (cl_context context,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueAcquireEGLObjectsKHR) (cl_command_queue
							 command_queue,
							 cl_uint num_objects,
							 const cl_mem *
							 mem_objects,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueReleaseEGLObjectsKHR) (cl_command_queue
							 command_queue,
							 cl_uint num_objects,
							 const cl_mem *
							 mem_objects,
...
/* cl_khr_egl_event */
  typedef cl_event (CL_API_CALL *
		    cl_api_clCreateEventFromEGLSyncKHR) (cl_context context,
							 CLeglSyncKHR sync,
							 CLeglDisplayKHR
							 display,
							 cl_int *
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clSetDefaultDeviceCommandQueue) (cl_context context,
							  cl_device_id device,
							  cl_command_queue
							  command_queue)
  ...
  typedef cl_program (CL_API_CALL *
		      cl_api_clCreateProgramWithIL) (cl_context context,
						     const void *il,
						     size_t length,
						     cl_int *
						     errcode_ret)
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetKernelSubGroupInfo) (cl_kernel kernel,
						   cl_device_id device,
						   cl_kernel_sub_group_info
						   param_name,
  ...
  typedef cl_kernel (CL_API_CALL *
		     cl_api_clCloneKernel) (cl_kernel source_kernel,
					    cl_int *
					    errcode_ret)
    CL_API_SUFFIX__VERSION_2_1;

  typedef cl_int (CL_API_CALL *
		  cl_api_clEnqueueSVMMigrateMem) (cl_command_queue
						  command_queue,
						  cl_uint num_svm_pointers,
  ...
  typedef cl_int (CL_API_CALL *
		  cl_api_clGetDeviceAndHostTimer) (cl_device_id device,
						   cl_ulong *
						   device_timestamp,
						   cl_ulong *
						   host_timestamp)
