...
typedef cl_int(CL_API_CALL * cl_api_clRetainDevice)(cl_device_id device) CL_API_SUFFIX__VERSION_1_2;
...
typedef cl_command_queue(CL_API_CALL * cl_api_clCreateCommandQueueWithProperties)(
    cl_context /* context */,
    cl_device_id /* device */,
...
typedef cl_int(CL_API_CALL * cl_api_clRetainCommandQueue)(cl_command_queue command_queue)
    CL_API_SUFFIX__VERSION_1_0;

typedef cl_int(CL_API_CALL * cl_api_clReleaseCommandQueue)(cl_command_queue command_queue)
    CL_API_SUFFIX__VERSION_1_0;
...
typedef void(CL_API_CALL * cl_api_clSVMFree)(cl_context /* context */, void * /* svm_pointer */)
    CL_API_SUFFIX__VERSION_2_0;
...
typedef cl_int(CL_API_CALL * cl_api_clUnloadPlatformCompiler)(cl_platform_id platform)
    CL_API_SUFFIX__VERSION_1_2;
...
typedef void *(CL_API_CALL * cl_api_clGetExtensionFunctionAddress)(const char * function_name)
    CL_API_SUFFIX__VERSION_1_1_DEPRECATED;
...
typedef cl_int(CL_API_CALL * cl_api_clSetMemObjectDestructorCallback)(
    ...
    void *
    /*user_data */) CL_API_SUFFIX__VERSION_1_1;
...
typedef cl_kernel(CL_API_CALL * cl_api_clCloneKernel)(cl_kernel source_kernel, cl_int * errcode_ret)
...
typedef cl_int(CL_API_CALL * cl_api_clGetHostTimer)(cl_device_id device, cl_ulong * host_timestamp)
    CL_API_SUFFIX__VERSION_2_1;
