...
/* when cl_intel_va_api_media_sharing is supported */
  ...
  typedef cl_int (CL_API_CALL *
		  clGetSupportedVA_APIMediaSurfaceFormatsINTEL_fn) (cl_context
								    context,
								    cl_mem_flags
								    flags,
								    cl_mem_object_type
...
#define CL_COMMAND_RELEASE_VA_API_MEDIA_SURFACES_INTEL 0x409B
  ...
  extern CL_API_ENTRY cl_int CL_API_CALL
    clGetDeviceIDsFromVA_APIMediaAdapterINTEL (cl_platform_id platform,
					       cl_va_api_device_source_intel
					       media_adapter_type,
					       void *media_adapter,
					       cl_va_api_device_set_intel
  ...
  typedef cl_int (CL_API_CALL *
    ...
    (cl_platform_id platform,
     cl_va_api_device_source_intel media_adapter_type, void *media_adapter,
     cl_va_api_device_set_intel media_adapter_set, cl_uint num_entries,
     cl_device_id * devices,
  ...
  typedef cl_mem (CL_API_CALL *
		  clCreateFromVA_APIMediaSurfaceINTEL_fn) (cl_context context,
							   cl_mem_flags flags,
							   VASurfaceID *
							   surface,
							   cl_uint plane,
