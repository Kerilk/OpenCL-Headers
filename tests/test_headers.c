...
test_char ()
{
  ...
  printf ("b8:  %d %d %d %d %d %d %d %d\n",
	  b8.s[0],
	  b8.s[1], b8.s[2], b8.s[3], b8.s[4], b8.s[5], b8.s[6], b8.s[7]);
  printf ("b16: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
	  ...
	  b16.s[8],
	  b16.s[9],
	  b16.s[10], b16.s[11], b16.s[12], b16.s[13], b16.s[14], b16.s[15]);
...
test_uchar ()
{
  ...
  printf ("__cl_uchar16: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
	  ...
	  ((cl_uchar *) & v16)[12],
	  ((cl_uchar *) & v16)[13],
	  ((cl_uchar *) & v16)[14], ((cl_uchar *) & v16)[15]);
#else
...
test_short ()
{
  ...
  printf ("__cl_short16: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
	  ...
	  ((cl_short *) & v16)[12],
	  ((cl_short *) & v16)[13],
	  ((cl_short *) & v16)[14], ((cl_short *) & v16)[15]);
#else
...
test_ushort ()
{
  ...
  printf ("__cl_ushort4:  %d %d %d %d \n",
	  ((unsigned short *) &v4)[0],
	  ((unsigned short *) &v4)[1],
	  ((unsigned short *) &v4)[2], ((unsigned short *) &v4)[3]);
#else
  ...
  printf ("__cl_ushort8:  %d %d %d %d %d %d %d %d \n",
	  ...
	  ((unsigned short *) &v8)[4],
	  ((unsigned short *) &v8)[5],
	  ((unsigned short *) &v8)[6], ((unsigned short *) &v8)[7]);
#else
  ...
  printf ("__cl_ushort16: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
	  ...
	  ((unsigned short *) &v16)[14], ((unsigned short *) &v16)[15]);
#else
...
test_int ()
{
  ...
  printf ("__cl_int4:  %d %d %d %d \n",
	  ((cl_int *) & v4)[0],
	  ((cl_int *) & v4)[1], ((cl_int *) & v4)[2], ((cl_int *) & v4)[3]);
#else
  ...
  printf ("__cl_int8:  %d %d %d %d %d %d %d %d \n",
	  ...
	  ((cl_int *) & v8)[3],
	  ((cl_int *) & v8)[4],
	  ((cl_int *) & v8)[5], ((cl_int *) & v8)[6], ((cl_int *) & v8)[7]);
#else
...
test_long ()
{
  ...
  printf ("b8:  %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %"
	  PRId64 " %" PRId64 " %" PRId64 "\n", b8.s[0], b8.s[1], b8.s[2],
	  b8.s[3], b8.s[4], b8.s[5], b8.s[6], b8.s[7]);
  printf ("b16: %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %"
	  PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64
	  " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 "\n",
	  b16.s[0], b16.s[1], b16.s[2], b16.s[3], b16.s[4], b16.s[5],
	  b16.s[6], b16.s[7], b16.s[8], b16.s[9], b16.s[10], b16.s[11],
	  b16.s[12], b16.s[13], b16.s[14], b16.s[15]);
  ...
  printf ("__cl_long8:  %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %"
	  ...
	  ((cl_long *) & v8)[0], ((cl_long *) & v8)[1], ((cl_long *) & v8)[2],
	  ((cl_long *) & v8)[3], ((cl_long *) & v8)[4], ((cl_long *) & v8)[5],
	  ((cl_long *) & v8)[6], ((cl_long *) & v8)[7]);
#else
  ...
  printf ("__cl_long16: %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %"
	  PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64
	  " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %" PRId64 " %"
	  PRId64 " \n", ((cl_long *) & v16)[0], ((cl_long *) & v16)[1],
	  ((cl_long *) & v16)[2], ((cl_long *) & v16)[3],
	  ((cl_long *) & v16)[4], ((cl_long *) & v16)[5],
	  ((cl_long *) & v16)[6], ((cl_long *) & v16)[7],
	  ((cl_long *) & v16)[8], ((cl_long *) & v16)[9],
	  ((cl_long *) & v16)[10], ((cl_long *) & v16)[11],
	  ((cl_long *) & v16)[12], ((cl_long *) & v16)[13],
	  ((cl_long *) & v16)[14], ((cl_long *) & v16)[15]);
#else
...
test_ulong ()
{
  ...
  printf ("__cl_ulong8:  %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %"
	  ...
	  ((cl_ulong *) & v8)[0], ((cl_ulong *) & v8)[1],
	  ((cl_ulong *) & v8)[2], ((cl_ulong *) & v8)[3],
	  ((cl_ulong *) & v8)[4], ((cl_ulong *) & v8)[5],
	  ((cl_ulong *) & v8)[6], ((cl_ulong *) & v8)[7]);
#else
  ...
  printf ("__cl_ulong16: %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %"
	  PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64
	  " %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %" PRIu64 " %"
	  PRIu64 " \n", ((cl_ulong *) & v16)[0], ((cl_ulong *) & v16)[1],
	  ((cl_ulong *) & v16)[2], ((cl_ulong *) & v16)[3],
	  ((cl_ulong *) & v16)[4], ((cl_ulong *) & v16)[5],
	  ((cl_ulong *) & v16)[6], ((cl_ulong *) & v16)[7],
	  ((cl_ulong *) & v16)[8], ((cl_ulong *) & v16)[9],
	  ((cl_ulong *) & v16)[10], ((cl_ulong *) & v16)[11],
	  ((cl_ulong *) & v16)[12], ((cl_ulong *) & v16)[13],
	  ((cl_ulong *) & v16)[14], ((cl_ulong *) & v16)[15]);
#else
...
test_float ()
{
  ...
  printf ("__cl_float16: %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f \n",
	  ...
	  ((cl_float *) & v16)[12],
	  ((cl_float *) & v16)[13],
	  ((cl_float *) & v16)[14], ((cl_float *) & v16)[15]);
#else
...
test_double ()
{
  ...
  printf ("__cl_double16: %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f \n",
	  ...
	  ((cl_double *) & v16)[12],
	  ((cl_double *) & v16)[13],
	  ((cl_double *) & v16)[14], ((cl_double *) & v16)[15]);
#else
...
{
  printf
    ("\nChecking operations on cl_types.\nNumbers, where presented, should walk upward from "
     "0, with step of 1:\n");
